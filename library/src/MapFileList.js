...
module.exports = {
  ...
  maps: [
    ...
    {
      name: "(X0 > LW1) Living World Season 1: Scarlet's War",
      maps: [
    ...
    {
      name: "(X0 > LW2) Living World Season 2: Glint's Prophecy",
      maps: [
    ...
    {
      name: "(X1) Guild Wars 2: Heart of Thorns (HoT)",
      maps: [
    ...
    {
      name: "(X1 > LW3) Living World Season 3: Glint's Legacy",
      maps: [
    ...
    {
      name: "(X2) Guild Wars 2: Path of Fire (PoF)",
      maps: [
    ...
    {
      name: "(X2 > LW4) Living World Season 4: Rise of Kralkatorrik",
      maps: [
    ...
    {
      name: "(X2 > LW5) Living World Season 5: The Icebrood Saga",
      maps: [
    ...
    {
      name: "(X3) Guild Wars 2: End of Dragons (EoD)",
      maps: [
    ...
    {
      name: "(X4) Guild Wars 2: Secrets of the Obscure (SotO)",
      maps: [
    ...
    {
      name: "(X5) Guild Wars 2: Janthir Wilds (JW)",
      maps: [
        ...
        { fileName: "3560860.data", name: "(???) Mists Vault [MapWizardsVault]" }
      ]
    },
    {
      name: "Guild Halls",
    ...
    },
    {
      ...
      maps: [
        ...
        { fileName: "291284.data", name: "(Dungeon #3.S) Twilight Arbor [MapWetlandGarden]" },
        { fileName: "645968.data", name: "(Dungeon #3.E) Twilight Arbor [MapWetlandGardenRepeat]" },
        ...
        { fileName: "473765.data", name: "(Dungeon #8.S) The Ruined City of Arah [MapRisenDragonStory]" },
        { fileName: "473930.data", name: "(Dungeon #8.E) The Ruined City of Arah [MapRisenDragonRepeat]" }
      ]
    },
    {
    ...
    },
    {
      ...
      maps: [
        ...
        { fileName: "3193573.data", name: "(Convergences #1) Outer Nayos [MapBountyIslands]" },
        { fileName: "3559095.data", name: "(Raid #8, Convergences #2) Mount Balrior [MapWildTitan]" }
      ]
    },
    {
      name: "Dragon Response Missions (DRM)",
      maps: [
    ...
    },
    {
      ...
      maps: [
        ...
        { fileName: "195806.data", name: "(Mist War #1) Eternal Battlegrounds, Obsidian Sanctum [MapWvWCenter]" },
        { fileName: "1798709.data", name: "(Mist War #1) Eternal Battlegrounds, Obsidian Sanctum [MapWvWCenterGliding]" },
        { fileName: "1885693.data", name: "(Mist War #1) Eternal Battlegrounds, Obsidian Sanctum [MapWvWCenter4]" },
        { fileName: "2263889.data", name: "(Mist War #1) Eternal Battlegrounds, Obsidian Sanctum [MapWvWCenterWallChange10_19]" },
    ...
    {
      name: "(Festival #1) Lunar New Year",
      maps: [
    ...
    {
      name: "(Festival #2) Super Adventure Festival",
      maps: [
    ...
    {
      name: "(Festival #3) Dragon Bash",
      maps: [
        { fileName: "2164993.data", name: "(City) Hoelbrak [MapAlpineHallDragonBash]" }
      ]
    },
    {
      name: "(Festival #4) Festival of the Four Winds",
      maps: [
        ...
        { fileName: "622681.data", name: "(FotFW) The Crown Pavilion [MapJubileeArena]" }
      ]
    },
    {
      name: "(Festival #5) Shadow of the Mad King",
      maps: [
    ...
    {
      name: "(Festival #6) A Very Merry Wintersday",
      maps: [
